...
using UserManagement.WebUI.Models;
using UserManagement.Core.Entities;
using UserManagement.Core.Interfaces;
using UserManagement.Core.Models.RequestModels.JQuery;
using UserManagement.Core.Models.ResponseModels.JQuery;
...
namespace UserManagement.WebUI.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var userQuery = await Task.Run(() => _userService.FetchUsers().AsQueryable());
